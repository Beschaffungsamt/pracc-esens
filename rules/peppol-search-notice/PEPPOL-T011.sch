...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="query:QueryRequest">
            <assert id="PEPPOL-T011-R001" flag="fatal" test="(rim:Slot[@name='SpecificationIdentification'])">A SearchN otice Request MUST have a specification identification.</assert>
        ...
        <rule context="query:QueryRequest/rim:Slot[@name='SpecificationIdentification']">
            <assert id="PEPPOL-T011-R014" test="rim:SlotValue[@xsi:type='rim:StringValueType']/rim:Value/text()[normalize-space() != '']">A value for Specification Id MUST be given.</assert>
        </rule>

        <rule context="query:QueryRequest/rim:Slot[@name='BusinessProcessTypeIdentifier']">
            <assert id="PEPPOL-T011-R015" test="rim:SlotValue[@xsi:type='rim:StringValueType']/rim:Value/text()[normalize-space() != '']">A value for Business Process Type Identifier MUST be given.</assert>
        </rule>

        <rule context="query:QueryRequest/rim:Slot[@name='Issue']">
            <assert id="PEPPOL-T011-R016" test="rim:SlotValue[@xsi:type='rim:DateTimeValueType']/rim:Value/text()[normalize-space() != '']">A value for Issue MUST be given.</assert>
        </rule>
